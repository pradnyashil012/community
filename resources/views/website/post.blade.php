          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="@if($post->user->image){{ asset($post->user->image) }} @else {{ asset('website/images/user.png') }} @endif" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
      ...
      <div class="container">
        ...
        <div class="col-md-5 order-md-2">
          ...
          @foreach($lastrelatedPost as $post)
            ...
            @foreach($firstrelatedPost2 as $post)
...
<script>
    ...
    */
    ...
    s.src = 'https://ipaytotal-blog.disqus.com/embed.js';
    s.setAttribute('data-timestamp', +new Date());
    (d.head || d.body).appendChild(s);
    })();
</script>
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript">comments powered by Disqus.</a></noscript>
<script id="dsq-count-scr" src="//ipaytotal-blog.disqus.com/count.js" async></script>
@endsection
