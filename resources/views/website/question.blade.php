        ...
        <div class="row same-height justify-content-center">
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              <span class="post-category text-white bg-success mb-3">Community Question</span>
              <h1 class="mb-4"><a href="javascript:void()">{{ $que->question }}</a></h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                ...
                <div class="bio-body">
                  <h2>{{ $que->name }}</h2>
                  <p>{{ $que->created_at->format('M d, Y') }}</p>
                </div>
              </div>
            </div>
            <!-- END sidebar-box -->  
